...
class TasksFragment : Fragment(R.layout.fragment_tasks), TaskAdapter.OnItemClickListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        //launchWhenStarted makes the scope smaller
        //the coroutine is started when onStart is called and destoyed when onStopped is called
        // the task will be executed when the activity is on foreground
        viewLifecycleOwner.lifecycleScope.launchWhenStarted {
            viewModel.taskEvent.collect { event ->
                ...
                }.exhaustive // exhaustive is used for compile time safety
            }
        }
    ...
    override fun onCreateOptionsMenu(menu: Menu, inflater: MenuInflater) {
        ...
        viewLifecycleOwner.lifecycleScope.launch {
            // read value from Flow only once and then cancel use .first()
